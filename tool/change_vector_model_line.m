function new_vector = change_vector_model_line(vector, param, unit_dir, is_RT)
if is_RT == 1
    new_vector = zeros(1, 9+2*param.num_camera+3*param.num_point+4*param.num_line);
    ...
    new_vector = zeros(1, 12*param.num_camera+3*param.num_point+4*param.num_line);
    for i = 1: param.num_camera
